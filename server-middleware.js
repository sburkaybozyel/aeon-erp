...
export function configuredTenantForHost(host) {
  ...
  if (isCloudflareWorker && hostname.endsWith('.workers.dev')) return 'aeon';
...
function staffPinKey() {
  const material = process.env.STAFF_PIN_ENCRYPTION_KEY || process.env.FIREBASE_PRIVATE_KEY || 'aeon-local-staff-pin-key';
