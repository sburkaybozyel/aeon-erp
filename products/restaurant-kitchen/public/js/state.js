// Read tenant_id from URL (supports module pages with an optional tenant_id query)
let _tenantFromUrl = 'restaurant_kitchen';
...
// Shared App State
export let state = {
  currentTenant: window.tenantId || 'restaurant_kitchen',
...
export async function loadAllData() {
  try {
    ...
    let config = { MODULE_DINING: true, MODULE_STAY: true, MODULE_CRUISE: false, MODULE_PRINTER: false, MODULE_POOL: false };
    if (cfgRes.ok) {
