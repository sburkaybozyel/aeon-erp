...
.location-map-side img { position: absolute; inset: 0; }
.location-info-side {
  background: var(--paper);
  padding: 7rem 5rem;
  display: flex;
...
.form-field-bare:last-child { border-right: none; padding-right: 0; padding-left: 2rem; }
.booking-form-row.single .form-field-bare { padding-left: 0; border-right: none; }
